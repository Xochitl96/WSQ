...
int main (){
	...
	cout << "This program evaluate all the numbers in a range you provide and shows how much palindrome numbers, non-Lychrel numbers and Lychrel are. Also print the Lychrel numbers:" << endl;
